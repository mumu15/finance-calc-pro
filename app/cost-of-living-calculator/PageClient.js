...
export default function Calculator() {
  ...
  return (
    <>
          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="number" step="any" min={30} max={400} step={5}
              ...
              <div>
                ...
                <input type="number" step="any" min={50} max={200} step={5}
              ...
              <div>
                ...
                <input type="number" step="any" min={-15} max={15} step={0.5}
      ...
      <TrustSection />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"Cost Of Living Calculator","item":"https://www.freefincalc.net/cost-of-living-calculator"}]})}} />
