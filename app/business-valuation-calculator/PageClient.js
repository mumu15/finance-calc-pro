...
export default function Calculator() {
  ...
  return (
    <>
          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="number" step="any" min={10000} max={50000000} step={10000}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={20000000} step={5000}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={10000000} step={5000}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={20000000} step={10000}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={10000000} step={10000}
      ...
      <TrustSection />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"Business Valuation Calculator","item":"https://www.freefincalc.net/business-valuation-calculator"}]})}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Business Valuation Calculator","applicationCategory":"FinanceApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","ratingCount":"2847","bestRating":"5","worstRating":"1"}})}} />
      <Footer />
    </>
  )
}
