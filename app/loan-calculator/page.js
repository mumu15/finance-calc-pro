      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 mt-12">
          ...
          <div className="mt-8 p-4 rounded-xl border" style={{borderColor:'rgba(240,200,66,0.2)',background:'rgba(240,200,66,0.05)'}}>
            ...
            <a href="/blog/how-to-calculate-loan-payment" className="font-semibold hover:underline" style={{color:'#f0c842'}}>How to Calculate Loan Payments: Complete Guide (2026)</a>
          </div>
      <Footer />
    </>
  )
