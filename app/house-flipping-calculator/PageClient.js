...
export default function Calculator() {
  ...
  return (
    <>
          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="number" step="any" min={20000} max={2000000} step={5000}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={10000} step={100}
              ...
              <div>
                ...
                <input type="number" step="any" min={2} max={12} step={0.5}
      ...
      <TrustSection />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"House Flipping Calculator","item":"https://www.freefincalc.net/house-flipping-calculator"}]})}} />
