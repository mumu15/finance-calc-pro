...
export default function Calculator() {
  ...
  return (
    <>
          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={0} max={100000000} step={10000}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={0} max={50000000} step={10000}
      ...
      <TrustSection />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"Estate Tax Calculator","item":"https://www.freefincalc.net/estate-tax-calculator"}]})}} />
