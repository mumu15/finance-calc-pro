...
export async function generateMetadata() {
  return {
    ...
    alternates: { canonical: 'https://freefincalc.net/debt-payoff-calculator/amount/70000' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://freefincalc.net/"},{"name":"Debt Payoff Calculator","url":"https://freefincalc.net/debt-payoff-calculator"},{"name":"70000","url":"https://freefincalc.net/debt-payoff-calculator/amount/70000"}]} includeReview={true} />
