...
export async function generateMetadata() {
  return {
    title: 'How Long to Pay Off $5,000 in Debt? | FreeFinCalc.net',
    description: 'Find out how long it takes to pay off $5,000 in debt. Calculate monthly payments, total interest and payoff date with our free debt payoff calculator.',
    alternates: { canonical: 'https://www.freefincalc.net/debt-payoff-calculator/amount/5000' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Debt Payoff Calculator","url":"https://www.freefincalc.net/debt-payoff-calculator"},{"name":"5000","url":"https://www.freefincalc.net/debt-payoff-calculator/amount/5000"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">How Long to Pay Off $5,000 in Debt?</h1>
          <p className="text-slate-400 text-lg mb-10">Use the calculator below to find out exactly how long it will take to pay off $5,000 in debt and how much interest you will pay in total.</p>
          <Client />
        </div>
      </main>
      <Footer />
