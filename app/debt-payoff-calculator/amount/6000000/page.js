...
export async function generateMetadata() {
  return {
    ...
    alternates: { canonical: 'https://www.freefincalc.net/debt-payoff-calculator/amount/6000000' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Debt Payoff Calculator","url":"https://www.freefincalc.net/debt-payoff-calculator"},{"name":"6000000","url":"https://www.freefincalc.net/debt-payoff-calculator/amount/6000000"}]} includeReview={true} />
