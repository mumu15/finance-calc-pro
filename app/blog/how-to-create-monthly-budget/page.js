...
export const metadata = {
  alternates: { canonical: 'https://www.freefincalc.net/blog/how-to-create-monthly-budget' },
...
export default function Post() {
  return (
    <>
      <FaqSchema faqs={faqs} />
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Blog","url":"https://www.freefincalc.net/blog"},{"name":"How To Create Monthly Budget","url":"https://www.freefincalc.net/blog/how-to-create-monthly-budget"}]} includeReview={true} />
      ...
      <section>
        ...
        <div style={{marginTop:32,marginBottom:32,padding:24,borderRadius:16,background:'rgba(240,200,66,0.04)',border:'1px solid rgba(240,200,66,0.15)'}}>
          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:8}}>
            ...
            <a href="/debt-to-income-calculator" style={{display:'inline-block',padding:'8px 14px',background:'rgba(240,200,66,0.08)',border:'1px solid rgba(240,200,66,0.2)',borderRadius:8,color:'#f0c842',textDecoration:'none',fontSize:13,fontWeight:600}}>Debt-to-Income</a>
          </div>
        </div>
      <Footer />
    </>
