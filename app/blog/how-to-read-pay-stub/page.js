...
export default function Post() {
  return (
    <>
      <FaqSchema faqs={faqs} />
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://freefincalc.net/"},{"name":"Blog","url":"https://freefincalc.net/blog"},{"name":"How To Read Pay Stub","url":"https://freefincalc.net/blog/how-to-read-pay-stub"}]} includeReview={true} />
