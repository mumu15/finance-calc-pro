...
export default function Page() {
  ...
  return (
    <div style={st.page}>
      ...
      <div style={st.wrap}>
        <nav style={st.bc}><a href="/" style={st.bcA}>Home</a><span style={{color:'#475569'}}>›</span><span style={{color:'#94a3b8'}}>Fixed vs Adjustable Rate Mortgage</span></nav>
        <h1 style={st.h1}>Fixed-Rate vs Adjustable-Rate Mortgage (ARM)</h1>
        <p style={st.sub}>Compare a locked fixed rate versus a lower initial ARM rate. See when each option wins.</p>
        <div style={st.box}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"Fixed vs Adjustable Rate Mortgage","item":"https://www.freefincalc.net/fixed-vs-adjustable-mortgage"}]})}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Fixed vs Adjustable Rate Mortgage","applicationCategory":"FinanceApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.9","ratingCount":"2847","bestRating":"5","worstRating":"1"}})}} />
      <Footer />
    </div>
  )
}
