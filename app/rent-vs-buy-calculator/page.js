...
export const metadata = {
  title: 'Rent vs Buy Calculator — Free Online Rent vs Buy Calculator | FreeFinCalc',
  description: 'Free Rent vs Buy Calculator — estimate housing costs, affordability, and make smarter real estate decisions. No sign-up required.',
  alternates: { canonical: 'https://freefincalc.net/rent-vs-buy-calculator' },
  openGraph: {
    title: 'Rent vs Buy Calculator — Free Online Rent vs Buy Calculator | FreeFinCalc',
    description: 'Free Rent vs Buy Calculator — estimate housing costs, affordability, and make smarter real estate decisions. No sign-up required.',
