...
export default function RvBCityClient({item:it,all}){
  ...
  return(<div style={s.page}><Header/>
    ...
    <div style={s.grid}>
      <div style={s.card}><label style={s.lbl}>Home Price</label><div style={s.val}>{fmt(home)}</div><input type="number" value={home} onChange={e=>setHome(+e.target.value)} className="calc-input"/></div>
      <div style={s.card}><label style={s.lbl}>Monthly Rent</label><div style={s.val}>{fmt(rent)}/mo</div><input type="number" value={rent} onChange={e=>setRent(+e.target.value)} className="calc-input"/></div>
      <div style={s.card}><label style={s.lbl}>Mortgage Rate</label><div style={s.val}>{rate}%</div><input type="number" value={rate} onChange={e=>setRate(+e.target.value)} className="calc-input"/></div>
      <div style={s.card}><label style={s.lbl}>How Long You Stay</label><div style={s.val}>{years} years</div><input type="number" value={years} onChange={e=>setYears(+e.target.value)} className="calc-input"/></div>
    </div>
    <div style={s.box}>
