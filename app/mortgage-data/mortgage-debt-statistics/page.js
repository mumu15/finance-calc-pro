      ...
      <div style={st.wrap}>
        ...
        <div style={st.box}>
          ...
          <div style={{overflowX:'auto'}}><table style={st.table}><thead><tr><th style={st.th}>Metric</th><th style={st.th}>Value</th><th style={st.th}>Notes</th></tr></thead><tbody>
              ...
              <tr style={{background:'transparent'}}><td style={{...st.td,fontWeight:600,color:'#e2e8f0'}}>Equity-Rich Homes</td><td style={{...st.td}}>48.3%</td><td style={{...st.td}}>Mortgage balance <50% of value</td></tr>
