...
export const metadata = {
  title: 'Debt to Income Calculator — Free Online Debt to Income Calculator | FreeFinCalc',
  description: 'Free Debt to Income Calculator — find the fastest way to pay off your debt, see interest saved, and create a payoff plan. No sign-up.',
          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="range" min={1000} max={50000} step={250}
