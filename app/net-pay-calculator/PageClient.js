...
export default function Calculator() {
  ...
  return (
    <>
          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="number" step="any" min={100} max={50000} step={50}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={2000} step={50}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={13} step={0.25}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={1000} step={10}
      ...
      <TrustSection />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"Net Pay Calculator","item":"https://www.freefincalc.net/net-pay-calculator"}]})}} />
