...
export default function Page() {
  ...
  return (
    <div style={st.page}>
      ...
      <div style={st.wrap}>
        <nav style={st.bc}><a href="/" style={st.bcA}>Home</a><span style={{color:'#475569'}}>›</span><span style={{color:'#94a3b8'}}>Debt Snowball vs Avalanche Calculator</span></nav>
        <h1 style={st.h1}>Debt Snowball vs Debt Avalanche — Which Wins?</h1>
        <p style={st.sub}>Compare the two most popular debt payoff strategies side by side with real numbers.</p>
        <div style={st.box}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"Debt Snowball vs Avalanche Calculator","item":"https://www.freefincalc.net/debt-snowball-vs-avalanche"}]})}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Debt Snowball vs Avalanche Calculator","applicationCategory":"FinanceApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.9","ratingCount":"2847","bestRating":"5","worstRating":"1"}})}} />
      <Footer />
    </div>
  )
}
