...
export const metadata = {
  title: 'Social Security Calculator — Free Online Social Security Calculator | FreeFinCalc',
  description: 'Free Social Security Calculator — get instant results with our easy-to-use calculator. 100% free, no sign-up required. Trusted by thousands.',
  alternates: { canonical: 'https://freefincalc.net/social-security-calculator' },
  openGraph: {
    title: 'Social Security Calculator — Free Online Social Security Calculator | FreeFinCalc',
    description: 'Free Social Security Calculator — get instant results with our easy-to-use calculator. 100% free, no sign-up required. Trusted by thousands.',
    url: 'https://freefincalc.net/social-security-calculator',
