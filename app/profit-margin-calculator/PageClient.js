          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={100} max={10000000} step={100}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={0} max={5000000} step={100}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={0} max={3000000} step={100}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={0} max={1000000} step={100}
