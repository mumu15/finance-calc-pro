      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">
            Home Affordability on <span className="text-emerald-400">$45K Income</span>
          </h1>
        ...
        <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6">
          <h2 className="text-white font-bold text-lg mb-4">Home Buying on $45K/Year</h2>
          <p className="text-slate-400 text-sm leading-relaxed">
            With an annual income of $45K, you can typically afford a home priced up to {fmt(maxHome)},
