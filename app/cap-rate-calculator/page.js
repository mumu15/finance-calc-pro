...
export const metadata = {
  title: 'Cap Rate Calculator — Free Online Cap Rate Calculator | FreeFinCalc',
  description: 'Free Cap Rate Calculator — get instant results with our easy-to-use calculator. 100% free, no sign-up required. Trusted by thousands.',
