      ...
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <nav className="text-sm text-slate-500 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-300">Bathroom Remodel</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Personal Loan for Bathroom Remodel</h1>
          <p className="text-slate-400 text-lg mb-10">Upgrade bathroom fixtures and finishes for comfort and value.</p>
          <Client />
        </div>
      </main>
      <Footer />
