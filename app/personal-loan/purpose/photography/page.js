...
export async function generateMetadata() {
  return {
    ...
    alternates: { canonical: 'https://www.freefincalc.net/personal-loan/purpose/photography' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Personal Loan Calculator","url":"https://www.freefincalc.net/personal-loan"},{"name":"Photography","url":"https://www.freefincalc.net/personal-loan/purpose/photography"}]} includeReview={true} />
