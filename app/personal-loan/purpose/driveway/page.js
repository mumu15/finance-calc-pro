...
export async function generateMetadata() {
  return {
    title: 'Personal Loan for Driveway | FreeFinCalc.net',
    description: 'Pave, repave or repair your driveway. Use our free calculator to estimate monthly payments.',
    alternates: { canonical: 'https://www.freefincalc.net/personal-loan/purpose/driveway' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Personal Loan Calculator","url":"https://www.freefincalc.net/personal-loan"},{"name":"Driveway","url":"https://www.freefincalc.net/personal-loan/purpose/driveway"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <nav className="text-sm text-slate-500 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-300">Driveway</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Personal Loan for Driveway</h1>
          <p className="text-slate-400 text-lg mb-10">Pave, repave or repair your driveway.</p>
          <Client />
        </div>
      </main>
      <Footer />
