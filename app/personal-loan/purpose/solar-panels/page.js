...
export async function generateMetadata() {
  return {
    title: 'Personal Loan for Solar Panels | FreeFinCalc.net',
    description: 'Finance a solar installation and reduce your monthly energy bills. Use our free calculator to estimate monthly payments.',
    alternates: { canonical: 'https://www.freefincalc.net/personal-loan/purpose/solar-panels' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Personal Loan Calculator","url":"https://www.freefincalc.net/personal-loan"},{"name":"Solar Panels","url":"https://www.freefincalc.net/personal-loan/purpose/solar-panels"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Personal Loan for Solar Panels</h1>
          <p className="text-slate-400 text-lg mb-10">Finance a solar installation and reduce your monthly energy bills.</p>
          <Client />
        </div>
      </main>
      <Footer />
