...
export async function generateMetadata() {
  return {
    title: 'Personal Loan for Garage | FreeFinCalc.net',
    description: 'Build a new garage or upgrade your existing one. Use our free calculator to estimate monthly payments.',
    alternates: { canonical: 'https://www.freefincalc.net/personal-loan/purpose/garage' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Personal Loan Calculator","url":"https://www.freefincalc.net/personal-loan"},{"name":"Garage","url":"https://www.freefincalc.net/personal-loan/purpose/garage"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Personal Loan for Garage</h1>
          <p className="text-slate-400 text-lg mb-10">Build a new garage or upgrade your existing one.</p>
          <Client />
        </div>
      </main>
      <Footer />
