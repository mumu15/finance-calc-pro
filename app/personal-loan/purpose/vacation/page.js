...
export async function generateMetadata() {
  return {
    title: 'Personal Loan for Vacation | FreeFinCalc.net',
    description: 'Fund travel and experiences and pay it off over time. Use our free calculator to estimate monthly payments.',
    alternates: { canonical: 'https://www.freefincalc.net/personal-loan/purpose/vacation' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Personal Loan Calculator","url":"https://www.freefincalc.net/personal-loan"},{"name":"Vacation","url":"https://www.freefincalc.net/personal-loan/purpose/vacation"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Personal Loan for Vacation</h1>
          <p className="text-slate-400 text-lg mb-10">Fund travel and experiences and pay it off over time.</p>
          <Client />
        </div>
      </main>
      <Footer />
