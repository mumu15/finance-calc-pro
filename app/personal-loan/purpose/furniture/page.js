...
export async function generateMetadata() {
  return {
    title: 'Personal Loan for Furniture | FreeFinCalc.net',
    description: 'Furnish your home with quality pieces without paying everything upfront. Use our free calculator to estimate monthly payments.',
    alternates: { canonical: 'https://www.freefincalc.net/personal-loan/purpose/furniture' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Personal Loan Calculator","url":"https://www.freefincalc.net/personal-loan"},{"name":"Furniture","url":"https://www.freefincalc.net/personal-loan/purpose/furniture"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Personal Loan for Furniture</h1>
          <p className="text-slate-400 text-lg mb-10">Furnish your home with quality pieces without paying everything upfront.</p>
          <Client />
        </div>
      </main>
      <Footer />
