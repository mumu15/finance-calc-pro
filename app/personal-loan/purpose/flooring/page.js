...
export async function generateMetadata() {
  return {
    title: 'Personal Loan for Flooring | FreeFinCalc.net',
    description: 'Replace carpet, install hardwood or upgrade tile throughout your home. Use our free calculator to estimate monthly payments.',
    alternates: { canonical: 'https://www.freefincalc.net/personal-loan/purpose/flooring' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Personal Loan Calculator","url":"https://www.freefincalc.net/personal-loan"},{"name":"Flooring","url":"https://www.freefincalc.net/personal-loan/purpose/flooring"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Personal Loan for Flooring</h1>
          <p className="text-slate-400 text-lg mb-10">Replace carpet, install hardwood or upgrade tile throughout your home.</p>
          <Client />
        </div>
      </main>
      <Footer />
