      ...
      <div style={st.wrap}>
        ...
        <div style={st.grid}>
          <div style={st.card}>
            ...
            <input type="text" inputMode="decimal" value={target} onChange={e => setTarget(+e.target.value)} className="calc-input" />
          </div>
          <div style={st.card}>
            <label style={st.lbl}>Timeframe (months)</label>
            <div style={st.val}>{months} mo ({(months/12).toFixed(1)} yrs)</div>
            <input type="text" inputMode="decimal" value={months} onChange={e => setMonths(+e.target.value)} className="calc-input" />
          </div>
