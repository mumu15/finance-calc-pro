          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={0} max={900000} step={100}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={0} max={20000} step={25}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={1} max={360} step={1}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={0} max={12} step={0.25}
