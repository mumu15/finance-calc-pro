  ...
  return (
    ...
    { name: 'Retirement Calculator', url: 'https://www.freefincalc.net/retirement-calculator' }
      ...
      <div style={s.wrap}>
        ...
        <div style={s.grid}>
          <div style={s.card}><label style={s.lbl}>Current Savings</label><div style={s.val}>{fmt(saved)}</div><input type="number" step="any" value={saved} onChange={e=>setSaved(+e.target.value)} className="calc-input"/></div>
          <div style={s.card}><label style={s.lbl}>Monthly Contribution</label><div style={s.val}>{fmt(monthly)}/mo</div><input type="number" step="any" value={monthly} onChange={e=>setMonthly(+e.target.value)} className="calc-input"/></div>
          <div style={s.card}><label style={s.lbl}>Annual Return Rate</label><div style={s.val}>{rate}%</div><input type="number" step="any" value={rate} onChange={e=>setRate(+e.target.value)} className="calc-input"/></div>
          <div style={s.card}><label style={s.lbl}>Retire at Age</label><div style={s.val}>{retireAt}</div><input type="number" step="any" value={retireAt} onChange={e=>setRetireAt(+e.target.value)} className="calc-input"/></div>
        </div>
        <div style={s.box}>
