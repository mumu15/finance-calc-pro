...
export default function Page() {
  ...
  return (
    <div style={st.page}>
      ...
      <div style={st.wrap}>
        <nav style={st.bc}><a href="/" style={st.bcA}>Home</a><span style={{color:'#475569'}}>›</span><span style={{color:'#94a3b8'}}>CD vs High-Yield Savings Calculator</span></nav>
        <h1 style={st.h1}>CD vs High-Yield Savings Account</h1>
        <p style={st.sub}>Lock your money in a CD or keep it liquid in a HYSA? See which earns more.</p>
        <div style={st.box}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"CD vs High-Yield Savings Calculator","item":"https://www.freefincalc.net/cd-vs-high-yield-savings"}]})}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"CD vs High-Yield Savings Calculator","applicationCategory":"FinanceApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.9","ratingCount":"2847","bestRating":"5","worstRating":"1"}})}} />
      <Footer />
    </div>
  )
}
