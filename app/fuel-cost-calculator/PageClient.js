...
export default function Calculator() {
  ...
  return (
    <>
          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="number" step="any" min={1000} max={100000} step={500}
              ...
              <div>
                ...
                <input type="number" step="any" min={5} max={150} step={1}
              ...
              <div>
                ...
                <input type="number" step="any" min={1} max={10} step={0.05}
      ...
      <TrustSection />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"Fuel Cost Calculator","item":"https://www.freefincalc.net/fuel-cost-calculator"}]})}} />
