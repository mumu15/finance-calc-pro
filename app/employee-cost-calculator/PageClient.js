          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="number" step="any" min={20000} max={500000} step={1000}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={50} step={5}
