...
export default function Calculator() {
  ...
  return (
    <>
          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={10000} max={2000000} step={5000}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={1} max={12} step={0.125}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={12} max={360} step={6}
      ...
      <TrustSection />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.freefincalc.net"},{"@type":"ListItem","position":2,"name":"Extra Payment Calculator","item":"https://www.freefincalc.net/extra-payment-calculator"}]})}} />
