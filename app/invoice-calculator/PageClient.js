          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={500000} step={10}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={50} step={0.5}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={120} step={1}
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={5} step={0.25}
