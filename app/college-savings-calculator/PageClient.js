          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="number" step="any" min={0} max={17} step={1}
              ...
              <div>
                ...
                <input type="number" step="any" min={2} max={6} step={1}
              ...
              <div>
                ...
                <input type="number" step="any" min={5000} max={100000} step={1000}
              ...
              <div>
                ...
                <input type="number" step="any" min={2} max={8} step={0.25}
