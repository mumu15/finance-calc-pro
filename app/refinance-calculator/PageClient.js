...
export default function Calculator() {
  ...
  return (
    <>
          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="number" min={10000} max={1000000} step={5000}
      ...
      <TrustSection />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://freefincalc.net"},{"@type":"ListItem","position":2,"name":"Refinance Calculator","item":"https://freefincalc.net/refinance-calculator"}]})}} />
