...
export async function generateMetadata() {
  return {
    title: 'Student Loan Calculator for Sociology Majors | FreeFinCalc.net',
    description: 'Average student loan debt for Sociology majors is $27 000. Calculate your monthly payments and total repayment cost.',
    alternates: { canonical: 'https://www.freefincalc.net/student-loan/major/sociology' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Student Loan Calculator","url":"https://www.freefincalc.net/student-loan"},{"name":"Sociology","url":"https://www.freefincalc.net/student-loan/major/sociology"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <nav className="text-sm text-slate-500 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-300">Sociology</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Student Loan Calculator for Sociology</h1>
