...
export async function generateMetadata() {
  return {
    ...
    alternates: { canonical: 'https://freefincalc.net/student-loan/major/chemistry' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://freefincalc.net/"},{"name":"Student Loan Calculator","url":"https://freefincalc.net/student-loan"},{"name":"Chemistry","url":"https://freefincalc.net/student-loan/major/chemistry"}]} includeReview={true} />
