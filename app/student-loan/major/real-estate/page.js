...
export async function generateMetadata() {
  return {
    title: 'Student Loan Calculator for Real Estate Majors | FreeFinCalc.net',
    description: 'Average student loan debt for Real Estate majors is $28 000. Calculate your monthly payments and total repayment cost.',
    alternates: { canonical: 'https://www.freefincalc.net/student-loan/major/real-estate' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Student Loan Calculator","url":"https://www.freefincalc.net/student-loan"},{"name":"Real Estate","url":"https://www.freefincalc.net/student-loan/major/real-estate"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Student Loan Calculator for Real Estate</h1>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-5 text-center">
              ...
              <p className="text-white text-2xl font-bold">$68 000</p>
            </div>
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-5 text-center">
              <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-1">Debt-to-Income</p>
              <p className="text-white text-2xl font-bold">494%</p>
            </div>
          </div>
          <Client />
        </div>
