...
export async function generateMetadata() {
  return {
    ...
    alternates: { canonical: 'https://freefincalc.net/student-loan/major/music' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://freefincalc.net/"},{"name":"Student Loan Calculator","url":"https://freefincalc.net/student-loan"},{"name":"Music","url":"https://freefincalc.net/student-loan/major/music"}]} includeReview={true} />
