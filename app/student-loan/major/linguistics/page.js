...
export async function generateMetadata() {
  return {
    ...
    alternates: { canonical: 'https://www.freefincalc.net/student-loan/major/linguistics' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Student Loan Calculator","url":"https://www.freefincalc.net/student-loan"},{"name":"Linguistics","url":"https://www.freefincalc.net/student-loan/major/linguistics"}]} includeReview={true} />
