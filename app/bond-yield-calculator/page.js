...
export const metadata = {
  title: 'Bond Yield Calculator — Free Online Bond Yield Calculator | FreeFinCalc',
  description: 'Free Bond Yield Calculator — get instant results with our easy-to-use calculator. 100% free, no sign-up required. Trusted by thousands.',
