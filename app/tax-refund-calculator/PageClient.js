          ...
          <div className="result-box">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={5000} max={500000} step={1000}
              ...
              <div>
                ...
                <input type="text" inputMode="decimal" min={0} max={80000} step={500}
