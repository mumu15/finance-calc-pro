...
export async function generateMetadata() {
  return {
    title: 'Private Equity Return Calculator | FreeFinCalc.net',
    description: 'Calculate your Private Equity investment return. Historical average return is 14% per year. See how your money grows over time.',
    alternates: { canonical: 'https://www.freefincalc.net/investment-return-calculator/asset/private-equity' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Investment Return Calculator","url":"https://www.freefincalc.net/investment-return-calculator"},{"name":"Private Equity","url":"https://www.freefincalc.net/investment-return-calculator/asset/private-equity"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Private Equity Return Calculator</h1>
          <p className="text-slate-400 text-lg mb-10">The historical average annual return for Private Equity is approximately 14%. Use the calculator below to see how your investment grows over time.</p>
          <Client />
        </div>
      </main>
      <Footer />
