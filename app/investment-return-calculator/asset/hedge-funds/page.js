...
export async function generateMetadata() {
  return {
    title: 'Hedge Funds Return Calculator | FreeFinCalc.net',
    description: 'Calculate your Hedge Funds investment return. Historical average return is 8% per year. See how your money grows over time.',
    alternates: { canonical: 'https://www.freefincalc.net/investment-return-calculator/asset/hedge-funds' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Investment Return Calculator","url":"https://www.freefincalc.net/investment-return-calculator"},{"name":"Hedge Funds","url":"https://www.freefincalc.net/investment-return-calculator/asset/hedge-funds"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <nav className="text-sm text-slate-500 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-300">Hedge Funds</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Hedge Funds Return Calculator</h1>
          <p className="text-slate-400 text-lg mb-10">The historical average annual return for Hedge Funds is approximately 8%. Use the calculator below to see how your investment grows over time.</p>
          <Client />
        </div>
      </main>
      <Footer />
