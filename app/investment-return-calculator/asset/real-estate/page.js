...
export async function generateMetadata() {
  return {
    title: 'Real Estate Return Calculator | FreeFinCalc.net',
    description: 'Calculate your Real Estate investment return. Historical average return is 8% per year. See how your money grows over time.',
    alternates: { canonical: 'https://www.freefincalc.net/investment-return-calculator/asset/real-estate' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Investment Return Calculator","url":"https://www.freefincalc.net/investment-return-calculator"},{"name":"Real Estate","url":"https://www.freefincalc.net/investment-return-calculator/asset/real-estate"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Real Estate Return Calculator</h1>
          <p className="text-slate-400 text-lg mb-10">The historical average annual return for Real Estate is approximately 8%. Use the calculator below to see how your investment grows over time.</p>
          <Client />
        </div>
      </main>
      <Footer />
