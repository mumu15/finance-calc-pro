...
export async function generateMetadata() {
  return {
    title: 'Stock Options Return Calculator | FreeFinCalc.net',
    description: 'Calculate your Stock Options investment return. Historical average return is 12% per year. See how your money grows over time.',
    alternates: { canonical: 'https://www.freefincalc.net/investment-return-calculator/asset/stock-options' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Investment Return Calculator","url":"https://www.freefincalc.net/investment-return-calculator"},{"name":"Stock Options","url":"https://www.freefincalc.net/investment-return-calculator/asset/stock-options"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <nav className="text-sm text-slate-500 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-300">Stock Options</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Stock Options Return Calculator</h1>
          <p className="text-slate-400 text-lg mb-10">The historical average annual return for Stock Options is approximately 12%. Use the calculator below to see how your investment grows over time.</p>
          <Client />
        </div>
      </main>
      <Footer />
