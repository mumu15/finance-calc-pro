...
export async function generateMetadata() {
  return {
    ...
    alternates: { canonical: 'https://freefincalc.net/investment-return-calculator/asset/agricultural-commodities' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://freefincalc.net/"},{"name":"Investment Return Calculator","url":"https://freefincalc.net/investment-return-calculator"},{"name":"Agricultural Commodities","url":"https://freefincalc.net/investment-return-calculator/asset/agricultural-commodities"}]} includeReview={true} />
