...
export async function generateMetadata() {
  return {
    ...
    alternates: { canonical: 'https://freefincalc.net/investment-return-calculator/asset/defined-benefit-plan' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://freefincalc.net/"},{"name":"Investment Return Calculator","url":"https://freefincalc.net/investment-return-calculator"},{"name":"Defined Benefit Plan","url":"https://freefincalc.net/investment-return-calculator/asset/defined-benefit-plan"}]} includeReview={true} />
