...
export async function generateMetadata() {
  return {
    ...
    alternates: { canonical: 'https://freefincalc.net/investment-return-calculator/asset/municipal-bonds' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://freefincalc.net/"},{"name":"Investment Return Calculator","url":"https://freefincalc.net/investment-return-calculator"},{"name":"Municipal Bonds","url":"https://freefincalc.net/investment-return-calculator/asset/municipal-bonds"}]} includeReview={true} />
