...
export async function generateMetadata() {
  return {
    title: 'RSUs Return Calculator | FreeFinCalc.net',
    description: 'Calculate your RSUs investment return. Historical average return is 10% per year. See how your money grows over time.',
    alternates: { canonical: 'https://www.freefincalc.net/investment-return-calculator/asset/rsus' },
  };
}
...
export default function Page() {
  return (
    <>
      <Header />
      <SchemaMarkup breadcrumbs={[{"name":"Home","url":"https://www.freefincalc.net/"},{"name":"Investment Return Calculator","url":"https://www.freefincalc.net/investment-return-calculator"},{"name":"Rsus","url":"https://www.freefincalc.net/investment-return-calculator/asset/rsus"}]} includeReview={true} />
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <nav className="text-sm text-slate-500 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-300">RSUs</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">RSUs Return Calculator</h1>
          <p className="text-slate-400 text-lg mb-10">The historical average annual return for RSUs is approximately 10%. Use the calculator below to see how your investment grows over time.</p>
          <Client />
        </div>
      </main>
      <Footer />
