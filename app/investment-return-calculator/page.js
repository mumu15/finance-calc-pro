...
export const metadata = {
  title: 'Investment Return Calculator — Free Online Investment Return Calculator | FreeFinCalc',
  description: 'Free Investment Return Calculator — project investment growth, returns, and compound interest over time. Instant results, no sign-up.',
