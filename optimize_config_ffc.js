...
console.log('✅ next.config.js upgraded for freefincalc.net!');
console.log('Run: git add . && git commit -m "Optimize next.config.js for performance" && git push origin master:main');
